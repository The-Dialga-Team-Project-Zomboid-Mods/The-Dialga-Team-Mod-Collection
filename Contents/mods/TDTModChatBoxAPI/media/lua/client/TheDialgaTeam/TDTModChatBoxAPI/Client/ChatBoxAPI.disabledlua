...
-- TODO: Tabs feature. Default to default tab for now.
TDTModChatBox.Tabs = {};
TDTModChatBox.CurrentTab = "Default";
...
function TDTModChatBox:initialise()
    ...
    TDTModChatBox:InitializeColorPicker(TDTModChatBox.Chatbox);
end

function TDTModChatBox:InitializeColorPicker()
